package com.edudu.beamsamplepipelines.Sinks;
...
//Source code based on https://raw.githubusercontent.com/apache/beam/master/examples/java/src/main/java/org/apache/beam/examples/complete/game/utils/WriteToText.java


public class WriteTextFile<InputT> extends PTransform<PCollection<InputT>, PDone> {
    ...
    public PDone expand(PCollection<InputT> teamAndScore) {
        if (windowed) {
            teamAndScore
                    ...
                    .apply(new WriteTextFile.WriteOneFilePerWindow(filenamePrefix));
        } else {
            teamAndScore
                    .apply("ConvertToRow", ParDo.of(new BuildRowFn()))
